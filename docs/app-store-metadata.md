...
## Privacy Policy URL
https://workspaceterminal.app/privacy

## Support URL
https://github.com/dizys/workspace-terminal-ios/issues

## Marketing URL
https://workspaceterminal.app

## App Review Notes
To test this app, you need access to a Coder deployment (https://coder.com). If you do not have one, you can set up a free trial at https://coder.com/docs/install.

Demo credentials are not applicable — the app connects to the reviewer's own Coder deployment. The app is a terminal client and requires a running Coder workspace to demonstrate functionality.
